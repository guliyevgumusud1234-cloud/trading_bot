...
from src.utils.utils import calculate_rsi, calculate_macd, calculate_ema, calculate_atr
...
def fetch_initial_data(symbol, timeframe):
    ...
    ohlcv_df.to_parquet(file_path, index=False)
    
    return ohlcv_df

def append_new_data(symbol, timeframe):
    # WebSocket üzerinden en son veriyi çek
